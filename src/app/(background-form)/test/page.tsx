...
import { generateCoursesForQuarter, getTopPriorityCourses } from "@/app/lib/get-planners-algs"
...
export default async function Test() {
  ...
  const courses2 = ['CSE40', 'CSE102', 'CSE103', 'CSE107', 'CSE114A', 'CSE115A', 'CSE120', 'CSE185S', 'CSE195'];
  ...
  const temp4 = await getTopPriorityCourses(courses2, 5, temp, 24);
  // console.log(temp)
  return (
    <>
